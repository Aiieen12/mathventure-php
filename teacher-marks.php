...
<div class="teacher-layout">
    <aside class="sidebar">
        <div class="sidebar-top">
            ...
            <nav class="side-nav">
                ...
                <a href="teacher-marks.php" class="nav-item active">
    ...
    <main class="main-content">
        ...
        <!-- ✅ WRAPPER INI YANG FIX SUSUNAN -->
        <div class="dashboard-shell teacher-marks-shell">
            ...
            <div class="stats-container">
                <div class="champion-card">
                    <div class="champ-info">
                        ...
                        <h3 class="name">
                            <?php echo !empty($students) ? htmlspecialchars($students[0]['firstname'] ?: $students[0]['username']) : "---"; ?>
                        </h3>
                        <div class="xp-badge">
                            <?php echo !empty($students) ? number_format($students[0]['current_xp']) : '0'; ?> XP
                        </div>
                    </div>
...
new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            data: [
                <?php echo $chartData['Cemerlang']; ?>,
                <?php echo $chartData['Gigih']; ?>,
                <?php echo $chartData['Aktif']; ?>
            ],
